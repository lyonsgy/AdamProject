...
static NSInteger  const kRoundWidth = 7;
static NSInteger  const kRoundSpacing = 10;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        _round1Color = [UIColor colorWithRed:99/255.0 green:210/255.0 blue:248/255.0 alpha:1.0];
        _round2Color = [UIColor colorWithRed:99/255.0 green:210/255.0 blue:248/255.0 alpha:0.6];
        _round3Color = [UIColor colorWithRed:99/255.0 green:210/255.0 blue:248/255.0 alpha:0.3];
        ...
        round1.centerX = round2.centerX - kRoundSpacing;
        round1.centerY = round2.centerY - kRoundSpacing;
        
        round3.centerX = round2.centerX + kRoundSpacing;
...
- (void)startAnim
{
    CGPoint otherRoundCenter1 = CGPointMake(_round1.centerX+kRoundSpacing/2, _round2.centerY);
    CGPoint otherRoundCenter2 = CGPointMake(_round2.centerX+kRoundSpacing/2, _round2.centerY);
    //圆1的路径
    UIBezierPath *path1 = [[UIBezierPath alloc] init];
    [path1 addArcWithCenter:otherRoundCenter1 radius:kRoundSpacing/2 startAngle:-M_PI endAngle:0 clockwise:true];
    UIBezierPath *path1_1 = [[UIBezierPath alloc] init];
    [path1_1 addArcWithCenter:otherRoundCenter2 radius:kRoundSpacing/2 startAngle:-M_PI endAngle:0 clockwise:false];
    ...
    [path2 addArcWithCenter:otherRoundCenter1 radius:kRoundSpacing/2 startAngle:0 endAngle:-M_PI clockwise:true];
    ...
    [path3 addArcWithCenter:otherRoundCenter2 radius:kRoundSpacing/2 startAngle:0 endAngle:-M_PI clockwise:false];
...
- (void)layoutSubviews
{
    ...
    _round1.centerX = _round2.centerX - kRoundSpacing;
    _round1.centerY = _round2.centerY - kRoundSpacing;
    
    _round3.centerX = _round2.centerX + kRoundSpacing;
