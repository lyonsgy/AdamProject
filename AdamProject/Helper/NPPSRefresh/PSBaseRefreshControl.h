...
/// 刷新控件的宽度，在这里调整
static CGFloat const kPSRefreshHeaderControlWidth = 44.0;
static CGFloat const kPSRefreshFooterControlWidth = 100.0;
...
@property (nonatomic) CGFloat refreshHeaderControlWidth;
@property (nonatomic) CGFloat refreshFooterControlWidth;
